...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Hero section */}
      <div className="bg-gradient-to-r from-primary to-primary-foreground rounded-xl shadow-xl mb-12 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-8">
            <h1 className="text-4xl md:text-5xl font-accent font-bold text-white leading-tight">
              Welcome to <span className="text-yellow-400">CryptGen</span> Class Portal
            </h1>
            ...
            <div className="mt-8">
              <Link href="/announcements">
                <Button size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-slate-950 font-bold mr-4">
      ...
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-primary mb-8 font-accent text-center">Core Class Members</h2>
      ...
      <div id="members">
        <h2 className="text-3xl font-bold text-primary mb-8 font-accent text-center">Class Members</h2>
        <MemberGrid />
      </div>
      
      {/* Class Activities Gallery */}
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-primary mb-8 font-accent text-center">Class Activities</h2>
